                        ...
                        MenuButton(title: "RESTART",
                                   ...
                                   destination: GameView(
                                    ...
                                    viewModel: GameViewModel(
                                        ...
                                        maxBubbles: settingViewModel.maxBubble), scoreViewModel: scoreViewModel))
...
#Preview {
    OverView(scoreViewModel: ScoreViewModel(),score: 0, name: "suwuwwwu").environmentObject(SettingViewModel())
}
